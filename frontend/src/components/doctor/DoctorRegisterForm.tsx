...
const DoctorRegisterForm = () => {
  ...
  const { doctorRegister, isRegistering } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await doctorRegister(data, navigate);
  };

  return (
    <div className="mt-15 flex items-center justify-center px-10">
      <div className="bg-white rounded-xl shadow-lg p-10 w-full max-w-lg mb-10 md:mb-20 ">
        <div className="flex flex-col items-center mb-6">
          ...
          <p>Register your account as a doctor</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-500 text-white font-semibold py-2 rounded-lg hover:bg-indigo-600 transition-colors"
